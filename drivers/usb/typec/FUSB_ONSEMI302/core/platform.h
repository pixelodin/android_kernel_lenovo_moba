...
typedef enum
{
    ...
    SVID_EVENT         =       0x00000032,
    DP_EVENT           =       0x00000035,
    PD_CONTRACT_ALL    =       PD_NEW_CONTRACT | PD_NO_CONTRACT,
    PD_STATE_CHANGED   =       0x00000020,
    ACC_UNSUPPORTED    =       0x00000040,
    DATA_ROLE          =       0x00000080,
    POWER_ROLE         =       0x00000039,
    BIST_DISABLED      =       0x00000100,
    BIST_ENABLED       =       0x00000200,
    BIST_ALL           =       BIST_ENABLED | BIST_DISABLED,
    ALERT_EVENT        =       0x00000400,
    PPS_STATUS_RECEIVED =      0x00000800,
    STATUS_RECEIVED    =       0x00001000,
    SRC_CAPS_EXT_RECEIVED =    0x00002000,
    EVENT_HARD_RESET   =       0x00004000,
    EVENT_PD_CONTRACT_FAILED = 0x00008000,
    EVENT_SRC_CAPS_UPDATED =   0x00010000,
