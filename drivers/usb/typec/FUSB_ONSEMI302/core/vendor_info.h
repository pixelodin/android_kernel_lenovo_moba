...
/* Sink Tab */
#define PD_Power_as_Sink 18000                //; FIXPDO max power
...
#define Snk_PDO_Op_Current1 400              //; emarke cable max_current 4000mA
#define Snk_PDO_Min_Voltage1 0              //; 0 V
#define Snk_PDO_Max_Voltage1 0              //; 0 V
#define Snk_PDO_Op_Power1 0                 //; 0 W

#define Snk_PDO_Supply_Type2 3              //; 0: Fixed, 3: PPS
#define Snk_PDO_Voltage2 0                  //; 0V
#define Snk_PDO_Op_Current2 100             //; (5000 mA)
#define Snk_PDO_Min_Voltage2 30             //; (3000 mV) ? 100mV units for PPS
#define Snk_PDO_Max_Voltage2 50             //; (5000 mV) ? 100mV units for PPS
...
#define Attempts_DiscvId_SOP_P_First         YES
