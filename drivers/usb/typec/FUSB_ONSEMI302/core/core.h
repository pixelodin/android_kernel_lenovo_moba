...
/**
 * @brief Send a Sink PPS Request after initial PD contract is established
 *
 ...
 *
 * @param port Pointer to the port structure
 * @param voltage Output voltage in 20mV units
 * @param current Operating Current in 50mA units
 * @param obj_pos Object position of Source PDO
...
/*
 * @brief Transmit any control message, e.g. GetPPSRequest
 *
 * Called by system after initial explicit contract. Can be called after pd is enabled
 * to queue a message to be transmitted in the Sink/SourceReady state.
 *
 * @param port Pointer to the port structure
